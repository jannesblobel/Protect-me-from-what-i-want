export default function Impressum() {
  return (
    <>
      <h1>Impressum</h1>
      <p>
        Angaben gemäß § 5 TMG: Joschua Rothenbacher Uferstraße 48, 73525
        Schwäbisch Gmünd Deutschland Kontakt: Telefon: 015739082816 E-Mail:
        joschua.rothenbacher@hfg.design{" "}
        <span>Verantwortlich für den Inhalt nach § 55</span>
        Abs. 2 RStV: Joschua Rothenbacher Adresse wie oben.
        <span>Schriftart Diese Webseite</span>
        ...
        Schriftart.
        <span>Haftungsausschluss (Disclaimer):</span>{" "}
        <span>Haftung für Inhalte</span> Als Diensteanbieter sind wir gemäß § 7
        ...
        entfernen.
        <span>Haftung für Links</span> Unser Angebot enthält Links zu externen
        ...
        <span>Urheberrecht</span> Die durch die Seitenbetreiber erstellten
