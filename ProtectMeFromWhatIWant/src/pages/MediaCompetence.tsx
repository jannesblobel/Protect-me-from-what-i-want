        ...
        <div>
            <div className="scroll-container" dir="ltr">
                <div className="section-1">
                    <h1 className="h2-pxgrotesk">Discover the spotlight theory to gain media- literacy</h1>
                    <div className="digital-content">
                        Let's rethink and redefine our approach to technologies and digital media. Being media-literacy (1) means mastering media while letting them have minimal control over us.
                        <br/><br/>
                        In order to cultivate media literacy, it is crucial to raise awareness of our actions, sharpen our inner and outer perceptions and develop strong self-management skills. This requires time, patience and occasional quiet moments in these fast-paced times.                
                    </div>
                ...
                <div className="section-2-center">
                    <div className="quote">
                        <div className="quote-text">
                            "Die Steuerung der Aufmerksamkeit ist daher eine der wertvollsten geistigen Fähigkeiten, die Sie entwickeln, pflegen und trainieren können"
                        </div>
                    ...
                    <div className="arrow-block">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="51" height="51" viewBox="0 0 51 51" fill="none">
                            <path d="M49.5 1L1.5 50M1.5 50V6.5M1.5 50H44.7" stroke="#E7E7E7" stroke-width="2"/>
                        </svg>
                    </div>
